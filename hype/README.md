...
|`pick_overall` | | number |
| `pick_round` | | number |
| `nba_mean_ws48` | | number |
| `nba_mean_vorp` | | number |
|`nba_mean_pipm` | | number |
| `nba_mean_wa` | | number  |
| `top_mean_ws48` | | number |
| `top_mean_vorp` | | number |
| ` top_mean_pipm` | | number |
| `top_mean_wa` | | number |
| `nba_mean_ws48_rank` | | number|
|`nba_mean_vorp_rank` | | number |
| `nba_mean_pipm_rank` | | number |
| `nba_mean_wa_rank` | | number |
| `top_mean_ws48_rank` | | number |
| `top_mean_vorp_rank` | | number |
| `top_mean_pipm_rank` | | number |
| `top_mean_wa_rank` | | number|
